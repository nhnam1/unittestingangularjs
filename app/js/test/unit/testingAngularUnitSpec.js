...
describe('Testing AngularJS Test Suite', function() {
    ...
    describe('Testing AngularJS Directive', function () {
        ...
        beforeEach(inject(function ($compile, $rootScope, $httpBackend, _conversionService_) {
            ...
            // scope.apiKey = "xyz";
            scope.apiKey = "1b5f5b3dd9f156456bd9931ff7c5c118";
        ...
        it('should update the weather for a specific destination', function () {
            ...
            expect(scope.destination.country).toBe("Australia");

            //console.log();

            httpBackend.expectGET("http://api.openweathermap.org/data/2.5/weather?q=" + scope.destination.city + "," + scope.destination.country + "&APPID=" + scope.apiKey).respond(
                {
        ...
        it('should add a message when there is a server error', function () {
            ...
            httpBackend.expectGET("http://api.openweathermap.org/data/2.5/weather?q=" + scope.destination.city  + "," + scope.destination.country + "&APPID=" + scope.apiKey).respond(500);
