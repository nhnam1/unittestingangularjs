...
testingAngularApp.controller('testingAngularCtrl', function ($rootScope, $scope, $http, $timeout) {
    ...
    // $scope.apiKey = "493cdb76acd3b9ad4fe206a81934f49b";
    ...
    return {
        ...
        controller: function ($http, $rootScope, $scope, conversionService) {
            $scope.getWeather = function (destination) {
                $http.get("http://api.openweathermap.org/data/2.5/weather?q="+ destination.city + "," + destination.country + "&APPID=" + $scope.apiKey).then(
